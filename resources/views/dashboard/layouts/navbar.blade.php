...
-->
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item dropdown">
            ...
            <img src="{{ asset('assets/images/Flag/indonesia-flag.png') }}" class="img-fluid rounded-circle" alt="user" style="height: 30px; min-width: 30px; width: 30px;">
                ...
                <div class="m-0 border-0 shadow-none card">
                    <div class="p-0 ">
                        <ul class="p-0 list-group list-group-flush">
                            <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img src="{{ asset('assets/images/Flag/england-flag.png') }}" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;"/>English</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="caption ms-3 d-none d-md-block ">
                ...
                <p class="mb-0 caption-sub-title">{{auth()->user()->company->company_name}}</p>
            </div>
            </a>
